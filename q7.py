...
parser.add_argument("-d", "--dataset", default="mnist",type=str,choices=["mnist","fashion_mnist"])
...
def main(x_train, y_train, x_val, y_val, input_size, no_hidden_layers, hidden_layer_size, no_of_classes, wt_initialisation, optimiser, activation_function, batch_size, eta, epoch, momentum, beta, beta1, beta2, loss_func, lambd, do_wandb_log, plot_conf_mat):
    layers = []
    ...
    if optimiser.lower() == "sgd":
      ...
      y_pred, y = nn.gradient_descent(x_train, y_train,x_val, y_val, no_of_classes, layers, activation_function, eta, epoch, loss_func, lambd, do_wandb_log)
...
momentum = 0.05
print("epochs: ",epochs,"| batch_size: ",batch_size,"| loss_func", loss_func,"| optimizer",  optimizer ,"| learning_rate: ", learning_rate,"| momentum", momentum, "| beta: ",beta, "| beta1:", beta1,"| beta2: ", beta2, "| lambd: ", lambd,"| no_of_hidden_layers:", no_of_hidden_layers, "| activation_function: ", activation_function,"| no_of_classes: ", no_of_classes)
main(x_train, y_train, x_val, y_val, input_size, no_of_hidden_layers, hidden_layer_size, no_of_classes, wt_initialisation, optimizer, activation_function, batch_size, learning_rate, epochs, momentum, beta, beta1, beta2, loss_func, lambd, do_wandb_log, plot_conf_mat)
